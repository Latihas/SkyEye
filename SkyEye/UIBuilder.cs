...
internal class UiBuilder : IDisposable {
	...
	internal static readonly List<(Vector3 worldpos, uint fgcolor, uint bgcolor, string name, ushort fateId, EurekaWeather SpawnRequiredWeather, bool SpawnByRequiredNight)> _eurekaList2D = [];
	internal static readonly List<ushort> _eurekaLiveIdList2D = [];
	private readonly List<ushort> _eurekaLiveIdList2DOld = [];
