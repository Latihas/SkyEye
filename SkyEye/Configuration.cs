...
public class Configuration : IPluginConfiguration {
    ...
    public bool PluginEnabled = true, SpeedUpEnabled = true, Overlay2DWeatherMapEnabled = true, Overlay3DEnabled = true, AutoRabbit = true, AutoRabbitWait = true, AutoFarm = false, FarmWait = false;
