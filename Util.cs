...
internal static class Util {
	...
	extension(ImDrawListPtr drawList) {
		internal void DrawText(Vector2 pos, string text, uint col, uint strokecol = 0xFF000000) {
		...
		internal void DrawMapDot(Vector2 pos, uint fgcolor, uint bgcolor, float radius = 4f) {
